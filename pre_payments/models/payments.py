...
class AccountPayment(models.Model):
    ...
    def _prepare_move_line_default_vals(self, write_off_line_vals=None):
        ...
        if self.is_taxed and self.total_tax_amount > 0:
            ...
            if not tax_account:
                raise UserError(f"No tax account found for the selected taxes.")
            ...
            for line in line_vals_list:
                ...
                # Update amount_currency if applicable
                if line.get('amount_currency'):
                    sign = 1 if line['amount_currency'] > 0 else -1
                    line['amount_currency'] += (sign * tx_amount)
    ...
    def action_post(self):
        """
        Odoo 16 posting logic. We rely on _prepare_move_line_default_vals 
        to have correct amounts so we don't have to manually overwrite residuals.
        """
